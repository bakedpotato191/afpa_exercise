...
<body>
	...
	<div class="wrapper">
		<div class="edit">
			<form method="POST" action="edit?id=${article.id}"
			...
			<form method="POST" action="delete?id=${article.id}">
			<input type="submit" id="deleteButton" name="action" value="Delete article">
			</form>
